...
public class ProvideScoreHandler implements ExternalTaskHandler {
  ...
  private final static Logger LOGGER = Logger.getLogger("PROVIDE-SCORE");
  @Override
  public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
    ...
    Logger.getLogger("scoreProvider")
        .log(Level.INFO, "Task 1: Credit score {0} for customer {1} provided!", new Object[]{creditScore, customerId});

    //new
    LOGGER.info("**************this is test from java*****************");
  }
